class ManagerModels:
    ...
    def get_model(self, name):
        if name == "rowGLAM-tokenizer":
            ...
            from .models.row_glam_20250811.torch_model import TorchModel
            import torch
            import os
            ...
            model.load_state_dict(torch.load(os.getenv("PATH_TORCH_ROW_GLAM"), weights_only=True, map_location=torch.device('cpu')))
            return model
