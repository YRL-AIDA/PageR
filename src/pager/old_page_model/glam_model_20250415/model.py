...
def get_final_model(conf):
    return get_img2phis(conf={
            "path_node_gnn": "",
            "path_edge_linear": "",
            "path_model": conf["GLAM_MODEL"],
            "H1": EXPERIMENT_PARAMS["H1"],
            "H2": EXPERIMENT_PARAMS["H2"],
            "node_featch": EXPERIMENT_PARAMS["node_featch"],
            "edge_featch": EXPERIMENT_PARAMS["edge_featch"],
            "seg_k": 0.5
